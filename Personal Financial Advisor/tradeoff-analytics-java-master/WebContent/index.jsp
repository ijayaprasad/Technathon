		...
		<div class="col-lg-12 col-xs-12">
			<div class="well">
				<div class="form-group row">
					<div class="col-lg-6 col-md-6 col-xs-6" style="display: none">
						<label for="problems" class="control-label">Select a
							...
							<option value="savings.json">Savings</option></select>

					</div>
					<div class="col-lg-6 col-md-6 col-xs-6 text-right">
						<input style="display: none;float: left;background-color: #FF6600;color: white;font-weight: bold; " type="button"
							value="What is suitable for me?" class="analyze btn"><span
				...
				<div class="form-group row">
					...
					<div class="col-lg-12 tableArea">
						...
						<div style="margin: 10px;">
							...
							<div>
								<span>The coverage percentage indicates the number of factors covered from these :
									Accidental, Family, Life</span>
							</div>
						</div>
					</div>
