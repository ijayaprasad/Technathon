...
public class DemoServlet extends HttpServlet {
	...
	private String username = "27e0fe1b-7d89-4665-b715-9f4131144492";
	private String password = "h4lT8yMJDnmv";
	...
	protected void doPost(final HttpServletRequest req, final HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			InputStreamEntity entity = new InputStreamEntity(req.getInputStream(), 0);
